...
export default function AddMedicationScreen() {
  ...
  const validateForm = () =>{
    ...
    if(!form.name.trim()){
        newError.name = "Frequency is required"
    }
    if(!form.name.trim()){
        newError.name = " Duration is required"
    }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    <TouchableOpacity style={styles.backButton}>
                        <Ionicons name="chevron-back" size={28} color={"#EC407A"} />
                    </TouchableOpacity>
                ...
                <View style={styles.section}>
                    ...
                    >
                        <View style={styles.dateIconContainer}>
                            <Ionicons name="calendar" size={20} color="#EC407A" />
                        </View>
                            ...
                            {form.times.map((time, index) => (
                                ...
                                >
                                    <View style={styles.timeIconContainer}>
                                        <Ionicons name="time-outline" size={20} color="#EC407A" />
                                    </View>
                        ...
                        <View style={styles.switchRow}>
                            <View style={styles.switchLabelContainer}>
                                <View style={styles.iconContainer}>
                                    <Ionicons name="notifications" color={"#EC407A"} />
                                </View>
                                <View>
                                    <Text style={styles.switchLabel}>Remainders</Text>
                                    <Text style={styles.switchSubLabel}>
                                        Get notifired when its time to take your medications
                                    </Text>
                                </View>
                            </View>
                            <Switch
                                trackColor={{ false: "#ddd", true: "#EC407A" }}
                                thumbColor={"white"}
                                onValueChange={(value) =>{
                ...
                <View style={styles.section}>
                    <View style={styles.textAreaContainer}>
                        ...
                        style={styles.textArea}
                            placeholder="Add notes or speical instructions ..."
                            placeholderTextColor="#999"
                            value={form.notes}
            ...
            <View style={styles.footer}>
                <TouchableOpacity style={
                    [styles.saveButton, isSubmitting && styles.saveButtonDisabled]
                } >
                    <LinearGradient
                        colors={["#FF69B4", "#EC407A"]}
                        start={{ x: 0, y: 0 }}
